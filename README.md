...
Ниже представлена схема решения на уровне отдельных контейнеров (по концепции C4Model). Данная схема показывает из каких элементов на среднем уровне должно состоять проектируемое решение и как эти элементы будут взаимодействовать между собой.

...
- [Дизайн архитектуры решения продающего контент через мобильные приложения](#дизайн-архитектуры-решения-продающего-контент-через-мобильные-приложения)
  ...
  - [Исходные данные](#исходные-данные)
    ...
    - [Architecture Decision Records](#architecture-decision-records)
      - [ADR-1: Выбор архитектурного стиля решения](#adr-1-выбор-архитектурного-стиля-решения)
      - [ADR-2: Выбор СУБД для управления контентом](#adr-2-выбор-субд-для-управления-контентом)
      - [ADR-3: Выбор СУБД для проведения заказов](#adr-3-выбор-субд-для-проведения-заказов)
      - [ADR-4: Хостинг решения](#adr-4-хостинг-решения)
      - [ADR-5: Уведомления](#adr-5-уведомления)
      - [ADR-6: Observability](#adr-6-observability)
    - [Глоссарий](#глоссарий)
...
- **QA-9**: Availability
  - Приложения должны иметь высокий уровень доступности. Для нас это означает высокое качество кода мобильных приложений и высокий уровень доступности сервисов Orders и Products
...
#### ADR-1: Выбор архитектурного стиля решения

#### ADR-2: Выбор СУБД для управления контентом

#### ADR-3: Выбор СУБД для проведения заказов

#### ADR-4: Хостинг решения

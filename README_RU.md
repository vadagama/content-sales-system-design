# Архитектура решения для продажи контента

Этот документ доступен на [английском](README.md) и [русском](README_RU.md) языках.

- [Архитектура решения для продажи контента](#архитектура-решения-для-продажи-контента)
